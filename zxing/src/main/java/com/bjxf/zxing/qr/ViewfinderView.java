...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            paint.setColor(getResources().getColor(R.color.lans_bg));
            ...
            canvas.drawLine(frame.left, frame.top, frame.right - ScreenRate, frame.top, paint);
            canvas.drawLine(frame.left, frame.top, frame.left, frame.bottom - CORNER_WIDTH, paint);
            canvas.drawLine(frame.right , frame.top, frame.right , frame.bottom - CORNER_WIDTH, paint);
