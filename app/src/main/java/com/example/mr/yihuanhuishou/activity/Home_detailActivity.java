            ...
            public boolean onMarkerClick(Marker marker) {
                if (!marker.isInfoWindowShown()){
                    if (TextUtils.equals("",type)){
                        ...
                        if (infoWindow == null){
                            infoWindow = LayoutInflater.from(Home_detailActivity.this).inflate(R.layout.view_qipao, null);
                        }
...
//                        startActivity(new Intent(Home_detailActivity.this,CompanyDetailActivity.class));
                    }
                }else {
