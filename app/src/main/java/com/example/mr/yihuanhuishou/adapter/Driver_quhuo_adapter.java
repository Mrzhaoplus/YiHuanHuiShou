...
public class Driver_quhuo_adapter extends RecyclerView.Adapter<Driver_quhuo_adapter.Holder> {
    Context context;
    List<String>list=new ArrayList<>();
    public Driver_quhuo_adapter(Context context) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.driver_quhuo_adapter, parent, false);
