...
import com.example.mr.yihuanhuishou.adapter.Driver_quhuo_adapter;
...
public class Driver_quhuozhong_fragment extends BaseFragment {
    ...
    protected void lazyLoad() {
        ...
        Driver_quhuo_adapter driver_all_adapter = new Driver_quhuo_adapter(getActivity());
