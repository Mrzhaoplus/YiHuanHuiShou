...
import com.example.mr.yihuanhuishou.adapter.Driver_daizhifu_adapter;
...
public class Driver_daizhifu_fragment extends BaseFragment {
    ...
    protected void lazyLoad() {
        ...
        Driver_daizhifu_adapter driver_all_adapter = new Driver_daizhifu_adapter(getActivity());
