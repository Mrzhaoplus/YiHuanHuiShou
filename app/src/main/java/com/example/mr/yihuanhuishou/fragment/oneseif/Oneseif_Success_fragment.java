...
public class Oneseif_Success_fragment extends BaseFragment {
    ...
    private Oneseif_Success_adapter oneseif_success_adapter;
                ...
                .execute(new DialogCallback<Order_Daijiedan_Bean>(getActivity(), Order_Daijiedan_Bean.class) {
                    ...
                    public void onSuccess(Response<Order_Daijiedan_Bean> response) {
                        ...
                        if (code.equals("200")) {
                            ...
                            oneseif_success_adapter.notifyDataSetChanged();
    ...
    private void initdata() {
        ...
        oneseif_success_adapter = new Oneseif_Success_adapter(getActivity(),mlist);
