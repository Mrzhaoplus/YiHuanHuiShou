...
public class Driver_YWC_DetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver__ywc__details);
    ...
    private void infoview() {
        ...
        OkGo.<Order_Details_Bean>get(MyUrls.BASEURL + "/driver/residentOrder/orderInfo")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<Order_Details_Bean>(Driver_YWC_DetailsActivity.this, Order_Details_Bean.class) {
                    @Override
                    public void onSuccess(Response<Order_Details_Bean> response) {
                        ...
                        if (code.equals("200")) {
                            ...
                            String dateToString3 = getDateToString(String.valueOf(endtime / 1000));
                            pswcsjTv.setText(dateToString3);

                        } else if (code.equals("201")) {
                            ToastUtils.getToast(Driver_YWC_DetailsActivity.this, body.getMsg());
    ...
    private void scdd() {
        ...
        OkGo.<Jiaoyan_Bean>post(MyUrls.BASEURL + "/driver/residentOrder/deleteOrder")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<Jiaoyan_Bean>(Driver_YWC_DetailsActivity.this, Jiaoyan_Bean.class) {
                    @Override
