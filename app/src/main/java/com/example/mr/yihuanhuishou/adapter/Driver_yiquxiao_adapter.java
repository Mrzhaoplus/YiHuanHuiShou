...
public class Driver_yiquxiao_adapter extends RecyclerView.Adapter<Driver_yiquxiao_adapter.Holder> {
    Context context;
    List<String>list=new ArrayList<>();
    public Driver_yiquxiao_adapter(Context context) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.driver_yiquxiao_adapter, parent, false);
