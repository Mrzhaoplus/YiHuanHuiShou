...
public class Driver_zhifu_success_DetailsActivity extends BaseActivity implements View.OnClickListener {
    @BindView(R.id.beak)
    ImageView beak;
    ...
    private void infoview() {
        ...
        OkGo.<Order_Details_Bean>post(MyUrls.BASEURL + "/recyclers/order/single")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<Order_Details_Bean>(Driver_zhifu_success_DetailsActivity.this, Order_Details_Bean.class) {
                    @Override
                    public void onSuccess(Response<Order_Details_Bean> response) {
                        ...
                        if (code.equals("200")) {
                            ...
                            fu_price.setText(demandinfo.getTotalPrice()+"元");
                            long paytime = recoveryOrder.getPaytime();
                            fu_time.setText(getDateToString(String.valueOf(paytime/1000)));
                        } else {
                            ToastUtils.getToast(Driver_zhifu_success_DetailsActivity.this, body.getMsg());
                        }
                    }
                    @Override
