...
import com.example.mr.yihuanhuishou.driver.exception.IllegalNumberException;
...
public class RatingBarView extends LinearLayout implements View.OnClickListener {
    private static final int DEFAULT_CHILD_DIMENSION = 13;//默认imageView的大小,宽高相等
    private static final int DEFAULT_CHILD_PADDING = 0;//默认imageView的内部padding,可以用来改变图片的大小
    private static final int DEFAULT_CHILD_MARGIN = 3;//imageView之间的距离
    private static final int DEFAULT_TOTAL_COUNT = 5;//默认Rating数量
    private static final int DEFAULT_SELECTED_COUNT = 3;//默认被选中的Rating数量
