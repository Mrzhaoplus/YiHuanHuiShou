...
public class Driver_peisongwan_adapter extends RecyclerView.Adapter<Driver_peisongwan_adapter.Holder> {
    Context context;
    List<String>list=new ArrayList<>();
    public Driver_peisongwan_adapter(Context context) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.driver_peisongwan_adapter, parent, false);
