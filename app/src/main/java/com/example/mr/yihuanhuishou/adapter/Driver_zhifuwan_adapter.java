...
public class Driver_zhifuwan_adapter extends RecyclerView.Adapter<Driver_zhifuwan_adapter.Holder> {

    Context context;
    List<String>list=new ArrayList<>();
    public Driver_zhifuwan_adapter(Context context) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.driver_zhifuwan_adapter, parent, false);
